...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String adjative = JOptionPane.showInputDialog("enter an adjective");
		// Get the user to enter a type of liquid
		String liquid = JOptionPane.showInputDialog("enter a liqiud");
		...
		JOptionPane.showMessageDialog(null, "Piranhas are more " + adjative
